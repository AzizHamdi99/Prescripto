        ...
        <form action="" className='border-[1px] border-[#D8D8D8] p-10'>
            ...
            <div className='grid grid-cols-2 gap-10 mt-10'>
                <div className='flex flex-col gap-3'>
                            ...
                            <label htmlFor="" className='text-[18px] text-[#5D607D] font-semibold'>Doctor name</label>
            ...
            <div className='mt-6 flex flex-col gap-3'>
                        ...
                        <textarea className='w-[921px] h-[156px] rounded-[5px] border-[1.5px] border-[#C1C1C1] px-3' name="" id="" placeholder='write about your self'></textarea>

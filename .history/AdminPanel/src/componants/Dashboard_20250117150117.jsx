...
.slice(0, 5);
  ...
  return (
    <div className='p-10 bg-[#f8f9fd] w-full'>
        ...
        <div className="mt-6 border-[1px] border-[#D8D8D8] bg-white shadow-md rounded-[5px] w-[60%] ">
            ...
            {latestAppointments.map((appointment, index) => {
                ...
                return (
                    <div key={index} className="bg-white p-4 rounded-[6px] flex gap-4 items-center">

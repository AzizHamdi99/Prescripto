...
function SideBar() {
  ...
  return (
    <div className='flex flex-col py-7 w-72 text-[18px] border-r-[#BEBEBE] border-[1px] h-[1000px]'>
        <div onClick={()=>navigate("/dashboard")} className={selected=="dashboard"?'flex items-center gap-2  px-7 py-2 bg-[#F2F3FF] cursor-pointer border-l-4 border-[#5F6FFF]':'flex items-center gap-2  px-7 py-2 bg-[#F2F3FF] cursor-pointer '}>
        <RxDashboard />
        <p>Dashboard</p>
        </div>

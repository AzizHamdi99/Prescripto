...
function AddDoctor() {
  return (
    <div className='p-10'>
        <p>Add Doctor</p>
        <form action="" className='border-[1px] border-[#D8D8D8] p-10'>
            ...
            <div className='grid grid-cols-2 gap-10 mt-10'>
                <div className='flex flex-col gap-3'>
                            ...
                            <label htmlFor="" className='text-[18px] text-[#5D607D] font-normal'>Doctor name</label>
            ...
            <div className='mt-6 flex flex-col gap-3'>
                        ...
                        <textarea className='text-[#A2A2A2] text-[18px] w-[921px] h-[156px] rounded-[5px] border-[1.5px] border-[#C1C1C1] px-3' name="" id="" placeholder='write about your self'></textarea>
                       
            </div>
            <button className='mt-10 bg-[#5F6FFF] px-12 py-3 rounded-[47px]'>Add doctor</button>

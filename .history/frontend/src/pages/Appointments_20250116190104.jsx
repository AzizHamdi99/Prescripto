      ...
      {appointment.map((item)=>{
        ...
        return(
          <div className="flex justify-between border-[1px] border-x-0 border-[#D1D1D1] py-5">
            ...
            <div className="flex flex-col gap-4 mt-19">
            <button className="px-14 py-3 bg-[#5F6FFF] rounded-[4px] text-[#FFFFFF] text-[16px]">Pay Here</button>
            <button className="px-14 py-3  rounded-[4px] text-black border-[1px] border-[#BABABA] text-[16px]">Cancel appointment</button>

...
const loginUser=async(e)=>{
  ...
  return <div className=" ">
    {login=="signUp"?
    <form onSubmit={registerUser} className="absolute flex flex-col top-[15%] left-[40%] border-[1px] w-[400px] p-8 pt-4 text-[#4B5563] rounded-[20px] shadow-xl ">
       ...
       <form onSubmit={loginUser} className="absolute flex flex-col top-[20%] left-[40%] border-[1px] w-[400px] p-8 text-[#4B5563] rounded-[20px] shadow-xl ">
       ...
       <input value={email} onChange={(e)=>setEmail(e.target.value)} type="email" className="border-[1px] border-[#DADADA] outline-none py-1 px-2 rounded-[4px]" />
       <label htmlFor="" className="text-[16px] font-normal mt-3">Password</label>
     
       <input value={password} onChange={(e)=>setPassword(e.target.value)} type="password" className=" rounded-[4px] border-[1px] border-[#DADADA] outline-none py-1 px-2" />
       <button type="submit" className="text-[18px] text-white font-meduim bg-[#5F6FFF] rounded-[6px] my-4 py-2">Login</button>

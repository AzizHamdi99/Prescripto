...
const [login,setlogin]=useState("signUp");
  ...
  return <div className=" ">
    ...
    <div className="absolute flex flex-col top-[20%] left-[40%] border-[1px] w-[400px] p-8 text-[#4B5563] rounded-[20px] shadow-xl ">
        ...
        <p className="text-[18px]  font-normal mt-1">{login =="signUp"?Please sign up to book appointment:Please login to book appointment}</p>
        ...
        <input type="date" className="border-[1px] border-[#DADADA] outline-none py-1 px-2 rounded-[4px]" />
        <label htmlFor="" className="text-[16px] font-normal mt-3">Gender</label>
        <select className="border-[1px] border-[#DADADA] outline-none py-1 px-2 rounded-[4px]"  name="" id="">

...
function Navbar() {
  ...
  const{select,setselect,token,setToken,login,setLogin}=useContext(AppContext)
    ...
    <div className="mx-32 flex my-4 items-center justify-between border-b-2 pb-4">
      ...
      {token? <div className="grid grid-flow-col gap-2 items-center group-relative ">
        ...
        <img src={assets.dropdown_icon} alt=""  />
          {token? <div className="absolute top-20 right-32 text-base font-medium p-4 text-gray-600 z-20 bg-[#F8F8F8] shadow-md">

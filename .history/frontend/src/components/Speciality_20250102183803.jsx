...
function Speciality() {
  const{SetSpeciality,setselect}=useContext(AppContext)
            ...
            <div className='flex items-center justify-evenly mt-10 '>
              {specialityData.map((item,index)=>{
                return(
                  ...
                  <Link to={`/doctors/${item.speciality}`} onClick={(item)=>update(item)} className=' cursor-pointer hover:translate-y-[-10px] transition-all duration-500 flex-shrink-0'>

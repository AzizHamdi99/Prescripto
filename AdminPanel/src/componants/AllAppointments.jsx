  ...
  return (
    <div className='p-8 pr-12 bg-[#f8f9fd] w-full'>
        ...
        <div className='border-[1px] border-[#D8D8D8] rounded-[5px] bg-white '>
            <div className='border-[1px]  border-[#E1E1E1] p-5 grid grid-cols-[0.25fr_0.95fr_1fr_1.1fr_1fr_0.6fr] text-[18px] text-[#323232] font-[500]'>
                <p>#</p>
                <p>Patient</p>
                <p>Department</p>
                <p>Date & Time</p>
            ...
            <div>
                {appointments.map((item)=>{
                    ...
                    return(
                        <div className='text-[18px] text-[#696B80] font[400] border-[1px] border-[#E1E1E1] p-5 items-center grid grid-cols-[0.25fr_0.9fr_1fr_1fr_1fr_0.5fr_0.1fr]' >
                            <p>{item.id}</p>
                            <p>{user.name}</p>
                            <p>{doctor.speciality}</p>
                            <p>{item.date}|{item.time} PM</p>
                            ...
                            <p>{doctor.fees}$</p>
                            <BadgeX onClick={()=>deleteAppointment(item.id)} className=' cursor-pointer' color="red" />  
